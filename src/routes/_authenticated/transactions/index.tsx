...
const txSearchSchema = z.object({
  ...
  status: z.array(z.enum(statusOptions.map((o) => o.value as any))).optional().catch([]),
  type: z.array(z.enum(typeOptions.map((o) => o.value as any))).optional().catch([]),
  method: z.array(z.enum(methodOptions.map((o) => o.value as any))).optional().catch([]),
