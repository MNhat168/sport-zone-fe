...
// Booking Status type for recurring bookings
                        ...
                        <Card className="bg-white shadow-md rounded-none border-0 gap-0">
                            <CardHeader className="border-b p-4 md:p-6">
                                <CardTitle className="text-lg md:text-xl font-semibold text-start flex items-center gap-2">
                                    <Repeat className="w-4 h-4 md:w-5 md:h-5 text-emerald-600 flex-shrink-0" />
                                    <span className="break-words">Đặt Sân Định Kỳ Hàng Tuần</span>
                                </CardTitle>
