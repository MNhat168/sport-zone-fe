...
export default function CoachVerifyPaymentsPage() {
    ...
    const fetchPendingProofs = async () => {
        ...
        try {
            ...
            // Fetch coach bookings with pending payment proof
            const response = await fetch(`${import.meta.env.VITE_API_URL}/bookings/pending-payment-proofs-coach`, {
                headers: {
    ...
    const handleConfirmVerify = async () => {
        ...
        try {
            ...
            // Use coach-specific endpoint
            const response = await fetch(
                `${import.meta.env.VITE_API_URL}/bookings/${selectedBooking._id || selectedBooking.id}/verify-payment-proof-coach`,
                {
                    method: 'PATCH',
                    headers: {
                        'Authorization': `Bearer ${token}`,
