...
interface PersonalInfoAiProps {
    ...
    /**
     * Batch Booking payload (for consecutive or weekly booking)
     */
    aiBookingPayload: any;
    /**
     * Batch Booking type: 'consecutive' or 'weekly'
     */
    aiBookingType: 'consecutive' | 'weekly';
}

/**
 * PersonalInfoAi component - Collects user personal information for batch/multiple booking
