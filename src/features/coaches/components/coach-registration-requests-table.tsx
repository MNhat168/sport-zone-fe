...
import { coachRegistrationRequestsColumns as columns } from './coach-registration-requests-columns'
import { registrationStatuses, sportsOptions } from '../data/data'

type DataTableProps = {
    data: CoachRegistrationRequest[]
    search: Record<string, unknown>
    navigate: NavigateFn
    isLoading?: boolean
}

export function CoachRegistrationRequestsTable({
    data,
    search,
    navigate,
    isLoading = false,
    ...
    const {
        ...
        columnFilters: [
            ...
            { columnId: 'sports', searchKey: 'sports', type: 'array' },
        ],
    })
