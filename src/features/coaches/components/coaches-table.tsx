...
import { coachesColumns } from './coaches-columns'
...
export function CoachesTable({ data, search, navigate, isLoading }: CoachesTableProps) {
    ...
    const {
        ...
        columnFilters: [
            ...
            { columnId: 'bankVerified', searchKey: 'isVerified', type: 'array' },
        ],
    })
