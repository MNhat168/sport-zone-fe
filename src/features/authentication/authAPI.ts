...
export const LOGIN_API = `${BASE_URL}/auth/login-fallback`; // Always use Bearer token flow
export const REGISTER_API = `${BASE_URL}/auth/register`;
export const GOOGLE_AUTH_API = `${BASE_URL}/auth/google/callback`;
export const GOOGLE_LOGIN_API = `${BASE_URL}/auth/google-fallback`; // Always use Bearer token flow
